...
Additionally, the browser extension leverages the `__vue__` property to detect components on the page, and [it wasn't sufficient for detecting _all_ components](#:~:text=Why%20is%20the%20__vue__%20property%20not%20enough%3F).
